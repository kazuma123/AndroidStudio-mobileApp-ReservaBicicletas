...
public class DetalleBicicletaElectrica extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalle_bicicleta_electrica);
        ...
        firebaseFirestore.collection("Bicicletas_Electricas").document(ID).get()
